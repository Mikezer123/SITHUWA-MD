...
global.github = 'https://github.com/Mikezer123/SITHUWA-MD'
...
global.devs = '13025449902';
global.website = 'https://github.com/Mikezer123/SITHUWA-MD' //wa.me/+13025449902
global.THUMB_IMAGE = process.env.THUMB_IMAGE || 'https://telegra.ph/file/08087652550991390c54f.jpg'
module.exports = {
  ...
  ownername: process.env.OWNER_NAME === undefined ? ' 𝑺𝒀𝑨𝑴_𝑺𝑬𝑹😚❤️' : process.env.OWNER_NAME,  
  ...
  caption :process.env.CAPTION || "\t*•ᴘᴏᴡᴇʀᴇᴅ ʙʏ ꜱɪᴛʜᴜᴡᴀ-ᴍᴅ•* ",   //*『ꜰᴏʟʟᴏᴡ • _ᴍʀ_ꜰʀᴏ_ᴜᴅ_』*\n HABIBBI!"),	
  ...
  LANG: process.env.THEME|| 'syam~ser',
